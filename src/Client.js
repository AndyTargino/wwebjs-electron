...
class Client extends EventEmitter {
    ...
    async initialize() {
        ...
        if (this.options.page) { page = this.options.page; browser = page.browser(); } else if (puppeteerOpts if (puppeteerOpts && (puppeteerOpts.browserWSEndpoint || puppeteerOpts.browserURL))if (puppeteerOpts && (puppeteerOpts.browserWSEndpoint || puppeteerOpts.browserURL)) (puppeteerOpts.browserWSEndpoint || puppeteerOpts.browserURL)) {
