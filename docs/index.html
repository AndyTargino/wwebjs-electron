...
<html>
        <head>
                ...
                <meta charset="utf-8">
        <title>whatsapp-web.js 1.34.7 &raquo; Home</title>
    ...
    <div id="jsdoc-navbar-container">
        <div id="jsdoc-navbar-content">
            <a href="index.html" class="jsdoc-navbar-package-name">whatsapp-web.<wbr>js 1.<wbr>34.<wbr>7</a>
        </div>
    </div>
</nav>
...
<h2>About</h2>
<p>whatsapp‑web.js is a powerful <a href="https://nodejs.org/en/download/">Node.js</a> library that lets you interact with WhatsApp Web, making it easy to build a dynamic WhatsApp API with nearly all features of the web client. It uses <a href="https://pptr.dev/">Puppeteer</a> to access WhatsApp Web’s internal functions and runs them in a managed browser instance to reduce the risk of being blocked.</p>
<h2>Links</h2>
<ul>
<li><a href="https://github.com/wwebjs/whatsapp-web.js">GitHub</a></li>
<li><a href="https://guide.wwebjs.dev/guide">Guide</a> (<a href="https://github.com/wwebjs/wwebjs.dev/tree/main">source</a>)</li>
<li><a href="https://docs.wwebjs.dev/">Documentation</a> (<a href="https://github.com/wwebjs/whatsapp-web.js/tree/main/docs">source</a>)</li>
<li><a href="https://discord.wwebjs.dev">Discord Server</a></li>
<li><a href="https://npmjs.org/package/whatsapp-web.js">npm</a></li>
</ul>
<h2>Installation</h2>
<p><strong>Node.js <code>v18.0.0</code> or higher, is required.</strong></p>
<pre class="prettyprint source lang-sh"><code>npm install whatsapp-web.js
yarn add whatsapp-web.js
pnpm add whatsapp-web.js
</code></pre>
<p>Having trouble installing? Take a peak at the <a href="https://guide.wwebjs.dev/guide">Guide</a> for more detailed instructions.</p>
<h2>Example usage</h2>
...
<p>Take a look at <a href="https://github.com/wwebjs/whatsapp-web.js/blob/main/example.js">example.js</a> for additional examples and use cases.<br>
For more details on saving and restoring sessions, check out the <a href="https://wwebjs.dev/guide/creating-your-bot/authentication.html">Authentication Strategies</a>.</p>
...
You may obtain a copy of the License at <a href="https:%5C/%5C/www.apache.org/licenses/LICENSE-2.0">https://www.apache.org/licenses/LICENSE-2.0</a>.</p>
...
limitations under the License.</p></article>
    ...
    <dl class="symbol-index-list">
            ...
            <dt class="symbol-index-name">
                <a href="Chat.html#isLocked" class="!symbol-index-name">Chat#<wbr>isLocked</a>
            </dt>
            <dd>
            </dd>
            <dt class="symbol-index-name">
    ...
    <dl class="symbol-index-list">
            ...
            <dt class="symbol-index-name">
                <a href="Client.html#cancelPairingCode" class="!symbol-index-name">Client#<wbr>cancelPairingCode()</a>
            </dt>
            <dd>
            </dd>
            <dt class="symbol-index-name">
            ...
            <dt class="symbol-index-name">
                <a href="Client.html#event:message_ciphertext_failed" class="!symbol-index-name">Client#<wbr>event:message_ciphertext_failed</a>
            </dt>
            <dd>
            </dd>
    </dl>
    ...
    <dl class="symbol-index-list">
            ...
            <dt class="symbol-index-name">
                <a href="Client.html#sendReaction" class="!symbol-index-name">Client#<wbr>sendReaction(messageId, reaction)</a>
            </dt>
            <dd>
            </dd>
            <dt class="symbol-index-name">
    ...
    <dl class="symbol-index-list">
            ...
            <dt class="symbol-index-name">
                <a href="global.html#Events#.MESSAGE_CIPHERTEXT_FAILED" class="!symbol-index-name">Events.<wbr>MESSAGE_CIPHERTEXT_FAILED</a>
            </dt>
            <dd>
            </dd>
            <dt class="symbol-index-name">
    ...
    <dl class="symbol-index-list">
            ...
            <dt class="symbol-index-name">
                <a href="GroupChat.html#isLocked" class="!symbol-index-name">GroupChat#<wbr>isLocked</a>
            </dt>
            <dd>
            </dd>
            <dt class="symbol-index-name">
    ...
    <dl class="symbol-index-list">
            ...
            <dt class="symbol-index-name">
                <a href="PrivateChat.html#isLocked" class="!symbol-index-name">PrivateChat#<wbr>isLocked</a>
            </dt>
            <dd>
            </dd>
            <dt class="symbol-index-name">
    ...
    <dl class="symbol-index-list">
            <dt class="symbol-index-name">
                <a href="window.WWebJS.html#.compareWwebVersions" class="!symbol-index-name">window.<wbr>WWebJS.<wbr>compareWwebVersions(lOperand, operator, rOperand)</a>
            </dt>
            <dd>
            </dd>
    </dl>
    ...
    <dl class="symbol-index-list">
            <dt class="symbol-index-name">
                <a href="window.WWebJS.html#.injectToFunction" class="!symbol-index-name">window.<wbr>WWebJS.<wbr>injectToFunction(target, callback)</a>
            </dt>
            <dd>
            </dd>
    </dl>
    ...
    <dl class="symbol-index-list">
                    ...
                    <footer id="jsdoc-footer" class="jsdoc-footer">
                            <div id="jsdoc-footer-container">
                                    <p>
                                      Generated by <a href="https://github.com/jsdoc3/jsdoc">JSDoc</a> 3.6.11 on April 24, 2026.
                                    </p>
                            </div>
                    </footer>
